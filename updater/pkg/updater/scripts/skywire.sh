...
binary="${GOPATH}/pkg/github.com/skycoin/skywire/cmd/${process_name}"

socksc_binary="${GOPATH}/pkg/github.com/skycoin/skywire/cmd/socks/socksc"
sockss_binary="${GOPATH}/pkg/github.com/skycoin/skywire/cmd/socks/sockss"
sshc_binary="${GOPATH}/pkg/github.com/skycoin/skywire/cmd/ssh/sshc"
sshs_binary="${GOPATH}/pkg/github.com/skycoin/skywire/cmd/ssh/sshs"
